...
import com.pasey.peculiardevices.blocks.devices.*;
...
public class PDBlocks {
    ...
    public static final RegistryObject<GeoElectricFurnace> GEO_ELECTRIC_FURNACE = BLOCKS.register("geo_electric_furnace", GeoElectricFurnace::new);
